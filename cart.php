           ...
           <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <h1 class="text-danger">Tour Packagess</h1>
                       ...
                       <p class="text-muted">You currently have <?php echo $count; ?> package(s) in your list</p>

                       <div class="table-responsive"><!-- table-responsive Begin -->

                           <table class="table text-primary"><!-- table Begin -->

                               <thead class='text-primary'><!-- thead Begin -->
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Begin -->
                       <div class="box same-height headline"><!-- box same-height headline Begin -->
                           <h3 class="text-center text-danger">Products You May Like</h3>
           ...
           <div class="col-md-3"><!-- col-md-3 Begin -->
               ...
               <div id="order-summary" class="box"><!-- box Begin -->
                   ...
                   <p class="text-muted"><!-- text-muted Begin -->
                       ...
                       Miscellaneous is calculated based on value you have entered
                       ...
                       <table class="table"><!-- table Begin -->
                           ...
                           <tbody><!-- tbody Begin -->
                               ...
                               <tr><!-- tr Begin -->
                                   ...
                                   <td> Booking All Sub-Total </td>
                                   <th class="text-primary"> $<?php echo $total; ?> </th>
