...
<body>
  ...
  <div class="wrapper">
    ...
    <i class="cancel-icon fas fa-times"></i>
       <a href="home.php"><i class="cancel-icon fas fa-times"></i></a>
    </label>
    <div class="icon"><i class="far fa-envelope"></i></div>
    <div class="content">
      <header>Become a Subscriber</header>
      <p>Subscribe to our travel page and get the latest offers straight to your inbox.</p>
    </div>
    ...
    if(isset($_POST['subscribe'])){ //if subscribe btn clicked
      ...
      if(filter_var($userEmail, FILTER_VALIDATE_EMAIL)){ //validating user email
        ...
        $message = "Thanks for subscribing to Tourbros . You'll always receive updates from us. And we won't share and sell your information.";
        $sender = "From: 190204002@aust.edu";
        //php function to send mail
        if(mail($userEmail,  $message, $sender)){
          ?>
